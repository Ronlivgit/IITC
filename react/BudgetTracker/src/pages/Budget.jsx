...
function Budget (props) {
    ...
    const isItExpense = (e) =>{
        ...
        setIsExpense(e.target.value == 'Expense' ? true : false)
        console.log(isExpense);
    }
    ...
    return (
        ...
        <>
            ...
            {budgets.map((item,index) => {
                return <PrintBudget delrow={deleteBudget} tracker={item} key={index} isExpense={isExpense} setIsExpense={setIsExpense} />
            })}
            </div>
        </>
        :
